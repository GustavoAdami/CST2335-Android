...
//        });
        ...
        goToToolbar.setOnClickListener(c -> {
        ...
        goToWeatherForecast.setOnClickListener(c -> {
            Intent weatherForecastPage = new Intent(ProfileActivity.this, WeatherForecast.class);
